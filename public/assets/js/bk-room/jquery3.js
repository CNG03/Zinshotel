        ...
        return (
            ...
            e.each(i, function (e, n) {
                (u = n.name),
                    ...
                    "skip" !== c &&
                        ((d = r.splitInputNameIntoKeysArray(p)),
                        (o = r.parseValue(o, u, c, a)),
                        r.deepSet(s, d, o, a));
            }),
            s
        );
        ...
        (e.serializeJSON = {
                    ...
                    i.each(function (t, a) {
                        (s = e(a)),
                            ...
                            u
                                ...
                                : o.isUndefined(r.checkboxUncheckedValue) ||
                                  n.push({
                                      name: a.name,
            ...
            validateType: function (n, r, t) {
                ...
                if (
                    ((i = e.serializeJSON),
                    (a = i.optionKeys(
                        t ? t.typeFunctions : i.defaultOptions.defaultTypes
                    )),
                    r && -1 === a.indexOf(r))
                )
                    throw new Error(
